 ...
 * Generates SEO-optimized content based on keywords and data insights
 */
export const contentGenerationTool = createTool({
  id: "content-generation",
  description:
    "Generates SEO-optimized content including blog posts, meta descriptions, and title tags based on keywords and analytics data",
  inputSchema: z.object({
    contentType: z
      .enum(["blog-post", "meta-description", "title-tag", "outline"])

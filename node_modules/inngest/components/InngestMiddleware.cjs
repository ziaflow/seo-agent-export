...
const getHookStack = async (middleware, key, arg, transforms) => {
	...
	for (const hook of hooksRegistered) {
		...
		for (const key$1 of hookKeys) {
			...
			ret[key$1] = require_functions.waterfall(fns, transform);
		}
	}
	for (const k of Object.keys(ret)) {
		const key$1 = k;
		ret[key$1] = require_functions.cacheFn(ret[key$1]);
	}
	return ret;
};
/**
...
Object.defineProperty(exports, 'InngestMiddleware', {
  enumerable: true,
  get: function () {
    return InngestMiddleware;
  }
});
exports.getHookStack = getHookStack;
//# sourceMappingURL=InngestMiddleware.cjs.map
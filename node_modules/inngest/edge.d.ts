 ...
 * ```
 */
declare const createExperimentalEndpointWrapper: (options: SyncHandlerOptions) => (handler: (req: Request) => Promise<Response>) => (req: Request) => Promise<Response>;
//#endregion
export { EdgeHandler, createExperimentalEndpointWrapper, frameworkName, serve };

...
import { createDeferredPromise, parseAsBoolean } from "../util.mjs";
import { api } from "../api.mjs";
import { topic } from "../topic.mjs";
import { Realtime } from "../types.mjs";
import { StreamFanout } from "./StreamFanout.mjs";
	...
	async connect() {
		...
		try {
			...
			this.#ws.onmessage = async (event) => {
				const parseRes = await Realtime.messageSchema.safeParseAsync(JSON.parse(event.data));
				if (!parseRes.success) {
...
//# sourceMappingURL=TokenSubscription.mjs.map